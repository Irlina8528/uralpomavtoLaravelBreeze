        ...
        <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
            ...
            <div class="row">
                ...
                <div class="form-floating col-sm-12 col-md-6">
                    <x-text-input id="update_password_password" name="password" type="password" class="mb-md-0"
                ...
                <div class="form-floating col-sm-12 col-md-6 pe-md-3">
                    <x-text-input id="update_password_password_confirmation" name="password_confirmation"
                        type="password" class="mb-md-0" autocomplete="new-password" placeholder="Подтвердите пароль" />
                    <a href="#" class="password-control mr-md-4"></a>
                ...
                @if (session('status') === 'password-updated')
                    <p x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 2000)"
                        class="text-sm text-gray-600 dark:text-gray-400">Новый пароль сохранен.</p>
                @endif
            </div>
        </form>
    </div>
