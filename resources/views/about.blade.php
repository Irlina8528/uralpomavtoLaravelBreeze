...
<section class="about" id="about">
    ...
    <div class="row">
        <div class="col">
            <p class="about__info info">УралПромАвто – логистическая компания, специализирующаяся в области грузоперевозок по России и странам СНГ. Наша цель – предоставление клиентам качественных и надежных услуг в сфере транспортировки грузов. Наш опыт и надежность позволяют нам предлагать конкурентоспособные цены и обеспечивать безопасность грузов во время транспортировки.</p>
        </div>
    </div>
    <div class="row">
        <div class="col">
