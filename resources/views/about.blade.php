...
@section('content')
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            <div class="col">
                <p class="about__info">УралПромАвто это</p>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="about__infos">
                    <p class="about__info">11 филиалов в городах России</p>
                    <p class="about__info">Екатеринбург, Москва, Санкт-Петербург, Омск, Челябинск, Тюмень, Сургут,
                        Краснодар, Хабаровск, Севастополь, Новосибирск</p>
                    <p class="about__info">Головной офис находится в городе Курган</p>
                </div>
            </div>
        </div>
        <div class="row">
